...
| LinkedIn `stuck` | `content/auto-apply.js`; terminal only after trusted mouse plus one trusted-keyboard recovery, with the step diagnostic attached to the ledger |
